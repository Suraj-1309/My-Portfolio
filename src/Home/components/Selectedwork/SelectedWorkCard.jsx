...
const SelectedWorkCard = ({ work, isDarkMode }) => {
  ...
  return (
    <>
      <button onClick={handleOpenCase} className="w-full">
        <div
          className={`rounded-[30px] p-3 w-full max-w-[450px] mx-auto border-8 border-double transition-transform duration-300 hover:scale-[1.02] ${
            isDarkMode
        ...
        >
          {/* Image */}
          <div className="w-full h-[240px] sm:h-[300px] lg:h-[320px] rounded-2xl overflow-hidden mb-4">
            <img
              src={work.image}
              alt={work.title}
