...
export default function FakeSkillArticle({ content, isDarkMode, onClose }) {
  ...
  return (
    ...
    >
      ...
      <div className="sticky top-3 sm:top-6 z-50 mx-auto flex w-[calc(100%-1rem)] sm:w-full max-w-[1090px] items-center justify-between rounded-full border border-gray-300 p-2 transition-all ease-in-out duration-700 animate-in fade-in-0 slide-in-from-top-[100%] bg-white dark:bg-black">
        <button
          onClick={onClose}
          type="button"
      ...
      {/* Article Content */}
      <div className="max-w-3xl w-full px-4 sm:px-6 py-12 sm:py-20">
        {/* Heading */}
        {heading && (
