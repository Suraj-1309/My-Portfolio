...
export default function FakePage({ content, isDarkMode, onClose }) {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl w-full px-4 sm:px-6 py-12 sm:py-20">
        ...
        {images.length > 0 && (
          <div className="flex overflow-x-auto gap-3 sm:gap-4 mb-10 scrollbar-thin scrollbar-thumb-rounded-md scrollbar-thumb-gray-400 flex algin-center justify-center">
            {images.map((src, idx) => (
              <img
                key={idx}
                src={src}
