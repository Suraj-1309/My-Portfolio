...
const AboutCard = ({ isDarkMode }) => {
  ...
  return (
    <div className={`rounded-3xl border p-6 shadow-sm ${bgClass} h-full w-full`}>
      <p className="mb-4 ">
        ...
        <span className={`${accentColor} font-semibold`}> 2nd year Student at GBPUAT in Computer Engg </span>. I'm a full-stack software engineer, AI enthusiast, Problem Solver. I build websites and applications 
      </p>
      <p className="mb-4">
        I am pretty good at working on complex projects to build efficient solutions.
      </p>
      <p className="mb-4">
        Off the clock, I dive into{" "}
        <span className={`${accentColor} font-semibold`}>anime</span>, geek
        out on the latest{" "}
      ...
      <div className="flex items-center justify-between mt-6">
        <div className="mt-6 flex flex-col items-start">
          <AnimatedText
            ...
            duration={0.6}
            tag="p"
            className="text-5xl font-signature"
            includeWhiteSpaces
            threshold={0.1}
            rootMargin="20%"
          >
  ...
  {[
    { icon: FaLinkedin, label: "LinkedIn", href: "https://linkedin.com/in/surajsc1" },
    { icon: FaGithub, label: "GitHub", href: "https://github.com/Suraj-1309" },
    { icon: FaEnvelope, label: "Email", href: "mailto:surajsinghch2055@gmail.com" },
